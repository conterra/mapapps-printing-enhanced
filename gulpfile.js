...
mapapps.registerTasks({
    ...
    themes: [/*"sample-theme"*/],
    /* state that the custom theme will be dependant from map.apps everlasting theme that provides the base css */
    hasBaseThemes: true,
    /* state that we want to support vuetify components and therefore need the the vuetify core css*/
    hasVuetify: true,
    /*themeChangeTargets: {
        "vuetify": [
            "sample_theme"
